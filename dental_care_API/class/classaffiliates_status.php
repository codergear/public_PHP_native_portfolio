...
class classaffiliates_status{
    public $status;
    public $id_affiliates_status = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($affiliates_status,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_affiliates_status(
            '".$affiliates_status->status."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($affiliates_status,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_affiliates_status(
            '".$affiliates_status->status."',
            '".$id_user."',
            '".$affiliates_status->id_affiliates_status."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $affiliates_status->id_affiliates_status;
        return true;
    } 
