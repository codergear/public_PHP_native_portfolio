...
class classcontracts_payments{
    public $transaction_id;
    public $contract;
    public $id_contracts_payments = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($contracts_payments,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_contracts_payments(
            '".$contracts_payments->transaction_id."',
            '".$contracts_payments->contract."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($contracts_payments,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_contracts_payments(
            '".$contracts_payments->transaction_id."',
            '".$contracts_payments->contract."',
            '".$id_user."',
            '".$contracts_payments->id_contracts_payments."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $contracts_payments->id_contracts_payments;
        return true;
    } 
