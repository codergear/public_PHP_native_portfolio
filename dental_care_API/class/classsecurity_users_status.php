...
class classsecurity_users_status{
    public $status;
    public $id_security_users_status = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($security_users_status,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_security_users_status(
            '".$security_users_status->status."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($security_users_status,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_security_users_status(
            '".$security_users_status->status."',
            '".$id_user."',
            '".$security_users_status->id_security_users_status."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $security_users_status->id_security_users_status;
        return true;
    } 
