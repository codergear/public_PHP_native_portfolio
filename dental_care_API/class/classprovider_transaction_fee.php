...
class classprovider_transaction_fee{
    public $transaction_fee;
    public $id_provider_transaction_fee = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($provider_transaction_fee,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_provider_transaction_fee(
            '".$provider_transaction_fee->transaction_fee."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($provider_transaction_fee,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_provider_transaction_fee(
            '".$provider_transaction_fee->transaction_fee."',
            '".$id_user."',
            '".$provider_transaction_fee->id_provider_transaction_fee."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $provider_transaction_fee->id_provider_transaction_fee;
        return true;
    } 
