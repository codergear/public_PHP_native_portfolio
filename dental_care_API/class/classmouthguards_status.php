...
class classmouthguards_status{
    public $status;
    public $id_mouthguards_status = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($mouthguards_status,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_mouthguards_status(
            '".$mouthguards_status->status."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($mouthguards_status,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_mouthguards_status(
            '".$mouthguards_status->status."',
            '".$id_user."',
            '".$mouthguards_status->id_mouthguards_status."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $mouthguards_status->id_mouthguards_status;
        return true;
    } 
