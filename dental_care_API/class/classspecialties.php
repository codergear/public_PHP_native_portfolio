...
class classspecialties{
    public $specialties;
    public $id_specialties = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($specialties,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_specialties(
    ...
    function update($specialties,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_specialties(
            '".$specialties->specialties."',
            '".$id_user."',
        ...
        $conn->Consulta($sql); 
        $last_id = $specialties->id_specialties;
        return true;
    } 
