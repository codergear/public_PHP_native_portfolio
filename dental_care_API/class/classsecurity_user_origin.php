...
class classsecurity_user_origin{
    public $origin;
    public $id_security_user_origin = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($security_user_origin,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_security_user_origin(
            '".$security_user_origin->origin."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($security_user_origin,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_security_user_origin(
            '".$security_user_origin->origin."',
            '".$id_user."',
            '".$security_user_origin->id_security_user_origin."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $security_user_origin->id_security_user_origin;
        return true;
    } 
