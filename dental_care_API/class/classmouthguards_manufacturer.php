...
class classmouthguards_manufacturer{
    public $manufacturer;
    public $id_mouthguards_manufacturer = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($mouthguards_manufacturer,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_mouthguards_manufacturer(
            '".$mouthguards_manufacturer->manufacturer."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($mouthguards_manufacturer,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_mouthguards_manufacturer(
            '".$mouthguards_manufacturer->manufacturer."',
            '".$id_user."',
            '".$mouthguards_manufacturer->id_mouthguards_manufacturer."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $mouthguards_manufacturer->id_mouthguards_manufacturer;
        return true;
    } 
