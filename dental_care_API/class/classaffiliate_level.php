...
class classaffiliate_level{
    public $affiliate_level;
    public $description;
    public $id_affiliate_level = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($affiliate_level,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_affiliate_level(
            '".$affiliate_level->affiliate_level."',
            '".$affiliate_level->description."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($affiliate_level,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_affiliate_level(
            '".$affiliate_level->affiliate_level."',
            '".$affiliate_level->description."',
            '".$id_user."',
            '".$affiliate_level->id_affiliate_level."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $affiliate_level->id_affiliate_level;
        return true;
    } 
