...
class classterms_conditions{
    public $terms_conditions_eng;
    public $id_terms_conditions = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($terms_conditions,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_terms_conditions(
            '".$terms_conditions->terms_conditions_eng."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($terms_conditions,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_terms_conditions(
            '".$terms_conditions->terms_conditions_eng."',
            '".$id_user."',
            '".$terms_conditions->id_terms_conditions."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $terms_conditions->id_terms_conditions;
        return true;
    } 
