...
class classsoftware_license_agreement{
    public $document_content;
    public $id_software_license_agreement = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($software_license_agreement,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_software_license_agreement(
            '".$software_license_agreement->document_content."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($software_license_agreement,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_software_license_agreement(
            '".$software_license_agreement->document_content."',
            '".$id_user."',
            '".$software_license_agreement->id_software_license_agreement."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $software_license_agreement->id_software_license_agreement;
        return true;
    } 
