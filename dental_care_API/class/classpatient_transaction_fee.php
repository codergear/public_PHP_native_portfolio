...
class classpatient_transaction_fee{
    public $transaction_fee;
    public $id_patient_transaction_fee = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($patient_transaction_fee,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_patient_transaction_fee(
            '".$patient_transaction_fee->transaction_fee."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($patient_transaction_fee,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_patient_transaction_fee(
            '".$patient_transaction_fee->transaction_fee."',
            '".$id_user."',
            '".$patient_transaction_fee->id_patient_transaction_fee."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $patient_transaction_fee->id_patient_transaction_fee;
        return true;
    } 
