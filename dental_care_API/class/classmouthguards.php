...
class classmouthguards{
    public $manufacturer;
    public $model;
    public $notes;
    public $id_mouthguards = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($mouthguards,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_mouthguards(
            '".$mouthguards->manufacturer."',
            '".$mouthguards->model."',
            '".$mouthguards->notes."',
            '".$id_user."',
            '0',
    ...
    function update($mouthguards,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_mouthguards(
            '".$mouthguards->manufacturer."',
            '".$mouthguards->model."',
            '".$mouthguards->notes."',
            '".$id_user."',
            '".$mouthguards->id_mouthguards."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $mouthguards->id_mouthguards;
        return true;
    } 
