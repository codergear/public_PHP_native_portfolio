...
class classunderwriter{
    public $underwriter;
    public $id_underwriter = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($underwriter,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_underwriter(
    ...
    function update($underwriter,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_underwriter(
            '".$underwriter->underwriter."',
            '".$id_user."',
        ...
        $conn->Consulta($sql); 
        $last_id = $underwriter->id_underwriter;
        return true;
    } 
