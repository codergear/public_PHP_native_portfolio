...
class classmouthguards_models{
    public $models;
    public $manufacturer;
    public $id_mouthguards_models = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($mouthguards_models,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_mouthguards_models(
            '".$mouthguards_models->models."',
            '".$mouthguards_models->manufacturer."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($mouthguards_models,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_mouthguards_models(
            '".$mouthguards_models->models."',
            '".$mouthguards_models->manufacturer."',
            '".$id_user."',
            '".$mouthguards_models->id_mouthguards_models."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $mouthguards_models->id_mouthguards_models;
        return true;
    } 
