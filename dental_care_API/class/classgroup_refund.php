...
class classgroup_refund{
    public $group_detail;
    public $amount;
    public $id_group_refund = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($group_refund,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_group_refund(
            '".$group_refund->group_detail."',
            '".$group_refund->amount."',
            '".$id_user."',
            '0',
            '',
    ...
    function update($group_refund,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_group_refund(
            '".$group_refund->group_detail."',
            '".$group_refund->amount."',
            '".$id_user."',
            '".$group_refund->id_group_refund."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $group_refund->id_group_refund;
        return true;
    } 
