...
class classcompensation_schedule{
    public $document_content;
    public $id_compensation_schedule = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($compensation_schedule,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_compensation_schedule(
            '".$compensation_schedule->document_content."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($compensation_schedule,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_compensation_schedule(
            '".$compensation_schedule->document_content."',
            '".$id_user."',
            '".$compensation_schedule->id_compensation_schedule."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $compensation_schedule->id_compensation_schedule;
        return true;
    } 
