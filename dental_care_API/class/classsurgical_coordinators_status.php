...
class classsurgical_coordinators_status{
    public $status;
    public $id_surgical_coordinators_status = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($surgical_coordinators_status,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_surgical_coordinators_status(
            '".$surgical_coordinators_status->status."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($surgical_coordinators_status,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_surgical_coordinators_status(
            '".$surgical_coordinators_status->status."',
            '".$id_user."',
            '".$surgical_coordinators_status->id_surgical_coordinators_status."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $surgical_coordinators_status->id_surgical_coordinators_status;
        return true;
    } 
