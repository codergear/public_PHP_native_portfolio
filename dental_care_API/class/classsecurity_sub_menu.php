...
class classsecurity_sub_menu{
    public $main_menu;
    public $name;
    public $location;
    public $parameter;
    public $id_security_sub_menu = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($security_sub_menu,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_security_sub_menu(
            '".$security_sub_menu->main_menu."',
            '".$security_sub_menu->name."',
            '".$security_sub_menu->location."',
            '".$security_sub_menu->parameter."',
            '".$id_user."',
            '0',
            '',
            '1'
    ...
    function update($security_sub_menu,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_security_sub_menu(
            '".$security_sub_menu->main_menu."',
            '".$security_sub_menu->name."',
            ...
            '".$security_sub_menu->parameter."',
            '".$id_user."',
            '".$security_sub_menu->id_security_sub_menu."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $security_sub_menu->id_security_sub_menu;
        return true;
    } 
