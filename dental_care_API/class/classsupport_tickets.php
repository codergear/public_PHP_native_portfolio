...
class classsupport_tickets{
    public $tickets_user;
    public $tickets_status;
    public $tickets_date;
    public $description;
    public $id_support_tickets = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($support_tickets,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_support_tickets(
            '".$support_tickets->tickets_user."',
            '".$support_tickets->tickets_status."',
            '".$support_tickets->tickets_date."',
    ...
    function update($support_tickets,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_support_tickets(
            '".$support_tickets->tickets_user."',
            '".$support_tickets->tickets_status."',
            ...
            '".$support_tickets->description."',
            '".$id_user."',
            '".$support_tickets->id_support_tickets."',
            '',
            '3'
        )"; 
        $conn->Consulta($sql); 
        $last_id = $support_tickets->id_support_tickets;
        return true;
    } 
