...
class classfacilities{
    ...
    public $notes;
    public $logo;
    public $id_facilities = 0;
    public $_user_umo;
    public $_date_umo;

    function insert($facilities,$id_user) {
        $conn = new classConexion();
        $sql = "CALL CRUD_facilities(
            '".$facilities->name."',
            '".$facilities->phone."',
            '".$facilities->email."',
            '".$facilities->contact_person."',
            '".$facilities->address."',
            '".$facilities->city."',
            '".$facilities->state."',
            '".$facilities->zip_code."',
    ...
    function update($facilities,$id_user){ 
        $conn = new classConexion();  
        $sql = "CALL CRUD_facilities(
            '".$facilities->name."',
            '".$facilities->phone."',
        ...
        $conn->Consulta($sql); 
        $last_id = $facilities->id_facilities;
        return true;
    } 
